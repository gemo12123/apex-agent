                ...
                assertInstanceOf(
                        ...
                        hook.apply(
                                KitFixtures.pre(
                                        call,
                                        KitFixtures.binding(
                                                AskHumanInterventionHook.REGISTRATION_NAME,
                                                List.of(AskHumanTool.NAME),
                                                Map.of()),
                                        null)));

        QuestionInterventionRequest request =
                assertInstanceOf(QuestionInterventionRequest.class, result.request());
        ...
        assertInstanceOf(
                ...
                hook.apply(
                        KitFixtures.pre(
                                ...
                                submission)));
        ToolResult result =
                tool.execute(call, KitFixtures.execution(submission), KitFixtures.OBSERVER);

...
默认生产事件为 STREAM_CONTENT、HUMAN_INTERVENTION、INVOCATION_DECLARED/CHANGE（工具/子调用路径）、循环异常时的 TASK_ERROR 和 END。兼容 DTO 仍识别 STREAM_THINK、PLAN、TASK_THINK、ARTIFACT，但默认运行不生产。

...
- Spring AI 模型调用会 dispose reactive subscription 并唤醒等待线程；callback-backed 工具中断当前 Manager 执行线程并清理取消产生的中断标记；手工 MCP Adapter 取消 call handle；HTTP SubAgent 取消 future/stream。
